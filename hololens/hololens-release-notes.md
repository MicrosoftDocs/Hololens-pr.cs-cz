...
- Portál zařízení nabízí vylepšené metody oznamování zákazníkovi, když Průzkumník souborů dochází k problémům s otevíráním uzamčených souborů.
...
- Opravili jsme Wi-Fi, kdy se při spuštění uživatelského rozhraní vlastností Wi-Fi ze souboru **Nastavení -> Network & Internet -> Status -> Properties** nespustila proxy server.
...
- Pokud **Nastavení > nahrání fotoaparátu > Mixed Reality system > Mixed Reality camera,** přejděte na .
...
> [!NOTE]
> Vzhledem k tomu, Nastavení nová aplikace Nastavení, budou při aktualizaci odebrána Nastavení okna, která jste předtím umístili kolem svého prostředí.
...
Od této Windows se prostředí veřejného terminálu v případě selhání v bezna mezinačtovém režimu skupiny AAD propadne ke globální konfiguraci veřejného terminálu (pokud je k dispozici).
...
Pokud navštívíte [stránku Page Nastavení Visibility](settings-uri-list.md), najdete pokyny k použití tohoto poskytovatele CSP a seznam identifikátorů URI dostupných v předchozích verzích.
...
| Ochrana osobních > – ohraničení snímku obrazovky                         | `ms-settings:privacy-graphicsCaptureWithoutBorder` |
...
| Předvolby > a > aplikace v nástroji System > Sound | `ms-settings:apps-volume`                          |
...
Sdílejte věci s dalšími Windows 10 zařízeními, včetně počítačů a dalších zařízení HoloLens 2. Můžete si ho vyzkoušet v **prostředích Nastavení** systému a sdílet soubory nebo adresy URL z  ->    ->   HoloLens do počítače. Další podrobnosti najdete v tématu Sdílení věcí s blízkými zařízeními [v Windows 10](https://support.microsoft.com/windows/share-things-with-nearby-devices-in-windows-10-0efbfe40-e3e2-581b-13f4-1a0e9936c2d9).
...
- Řešení potíží bude vyžadovat buď diagnostiku na serveru Připojená mezipaměť, nebo shromažďování trasování v HoloLens v HoloLens prostřednictvím řešení potíží se zabezpečením Nastavení  >  **Update & Windows**  >     >   **Update.**
...
✔️ nové [**Nastavení uri pro viditelnost** Nastavení stránky](#new-settings-uris-for-page-settings-visibility)
...
Dříve v případě selhání při použití bezobrazovkovém režimu se HoloLens k zobrazení všech aplikací v nabídce Start. Nyní v Windows Holographic verze 20H2 v případě selhání se v nabídce Start nezobrazí žádné aplikace, jak je znázorněno níže:
...
- **Menší krádež rukou:** Vylepšili jsme zpracování případů, kdy jsou na pohled na senzory více než dvě ruce. Pokud spolu úzce pracuje více lidí, je teď mnohem menší pravděpodobnost, že sledovaná ruky "přeskočí" z uživatele do ruky někoho jiného ve scéně.
...
- Opravili jsme chybu, Wi-Fi se pravidelně HoloLens streamování do aplikace. Pokud aplikace indikuje, že potřebuje streamování s nízkou latencí, implementujte opravu voláním funkce [SetSocketMediaStreamingMode](/windows/win32/api/socketapi/nf-socketapi-setsocketmediastreamingmode).
...
- Opravili jsme problém, kdy se subsystému sledování očí za určitých podmínek nepodařilo inicializovat nebo provést operaci.
...
- Problém vyžaduje, abyste po spuštění Cortana zařízení spouštěl hlasové Cortana". Pokud jste aktualizovali ze sestavení 18362, může se zobrazit také druhá dlaždice aplikace pro předchozí verzi aplikace Cortana, která už v nabídce **Start** nefunguje.
