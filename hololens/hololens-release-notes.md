...
- Nastavení vyhledávání: Vyhledejte nastavení z domovské Nastavení pomocí klíčových slov nebo názvu nastavení.
...
- Zařízení už nemůžete přejmenovat pomocí aplikace Nastavení. Správci IT mohou zařízení přejmenovat pomocí šablony [Windows Autopilot pro HoloLens 2 nebo](hololens2-autopilot.md) uzlu MDM [DevDetail CSP](/windows/client-management/mdm/devdetail-csp) Ext/Microsoft/DNSComputerName.
...
Pomocí tohoto nového nastavení můžete vybrat alternativní profil barev pro váš HoloLens 2. Barvy se tak můžou zdát přesnější, zejména při nižších úrovních jasu zobrazení. Barvu můžete zobrazit v aplikaci Nastavení, a to na stránce System > Aplikace.
...
1. Spusťte aplikaci **Nastavení** a přejděte na **System > Zakašlovací funkce.**
...
1. Po pokračování v dialogových oknech s pokyny se vaše zobrazení automaticky ztmaní na 30% jas.
    > [!TIP]
    > Pokud ve svém prostředí máte potíže se zobrazením tlumené scény, můžete ručně upravit úroveň jasu HoloLens 2 pomocí tlačítek jasu na levé straně zařízení.
...
> - Pokud se chcete vrátit k původnímu profilu barev zobrazení, můžete to udělat na stránce Nastavení (podívejte se, jak [resetovat profil barev).](#how-to-reset-color-profile)
...
>
> Potom pomocí rozevíracího seznamu nastavte externí mikrofon na **Výchozí** nebo **Výchozí komunikace.** Volba **výchozí** znamená, že se externí mikrofon bude používat všude.
>
...
Windows Holographic verze 20H2 je teď k dispozici a přináší skvělou sadu nových funkcí pro HoloLens 2 uživatele a IT specialisty. Od funkce automatického umistění do Správce certifikátů v Nastavení, vylepšené funkce bezobrazovkového režimu a nové možnosti nastavení Autopilotu. Tato nová aktualizace umožňuje IT týmům převzít podrobnější kontrolu nad konfigurací a správou HoloLens zařízení a nabízí uživatelům ještě hladká holografická prostředí. 

Tato nejnovější verze je měsíční aktualizací verze 2004, ale tentokrát zahrnujeme nové funkce. Hlavní číslo sestavení zůstane stejné a Windows Update bude označovat měsíční verzi verze 2004 (build 19041). Na číslo sestavení se můžete podívat na obrazovce Nastavení > o aplikaci a potvrdit, že jste na nejnovějším dostupném buildu 19041.1128+. Pokud chcete provést aktualizaci na nejnovější verzi, otevřete aplikaci Nastavení, přejděte na Update & Security a klepněte na Zkontrolovat aktualizace. Další informace o správě aktualizací HoloLens najdete v tématu [Správa HoloLens aktualizací.](hololens-updates.md)
...
Ve HoloLens 2 umožňují pozice očí přesné umístění hologramu, pohodlné zobrazení a vylepšenou kvalitu zobrazení. Pozice očí se vypočítává interně jako součást výpočtu sledování očí. To ale vyžaduje, aby každý uživatel přešel přes kalibraci sledování očí, a to i v případě, že prostředí nemusí vyžadovat pohledu.
...
1. Napřed HoloLens 2 členem skupiny vytvořené v předchozím kroku a aktivujte synchronizaci.  
...
Dříve při použití bezobrazovkového režimu došlo k selhání, HoloLens se v nabídce Start použily k zobrazení všech aplikací. Nyní v Windows Holographic verze 20H2 v případě selhání se v nabídce Start nezobrazí žádné aplikace, jak je znázorněno níže:
...
|     [EnergySaverBatteryThresholdOnBattery](/windows/client-management/mdm/policy-csp-power#power-energysaverbatterythresholdonbattery)     |  Příklad hodnoty, která se Windows návrháři konfigurace, tj. 100                                                                             |
...
- Opravili jsme problém, který způsoboval HoloLens aplikace se při použití HoloLens Emulator hardwarovou akcelerací na určitých zařízeních vrací do prostředí.
...
- Když k Portál zařízení přes Wi-Fi připojení, webový prohlížeč může přístup k bránit kvůli neplatnému certifikátu. Prohlížeč může nahlásit chybu typu "ERR_SSL_PROTOCOL_ERROR", i když byl certifikát zařízení dříve důvěryhodný. V takovém případě nemůžete postupovat k Portál zařízení, protože neexistuje možnost ignorovat upozornění zabezpečení. Tato aktualizace tento problém vyřešila. Pokud byl certifikát zařízení dříve stažen a na počítači důvěryhodný pro odebrání upozornění zabezpečení prohlížeče a dojde k chybě SSL, je třeba nový certifikát stáhnout a důvěřovat, aby se odstranila upozornění zabezpečení prohlížeče.
...
- Opravili jsme problém, který způsob HoloLens, které změnily formát pixelů tak, aby se v emulátoru pixelů HoloLens černě.
