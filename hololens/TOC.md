...
# Přehled zařízení
## [o HoloLens 2](hololens2-hardware.md)
## [co se dá HoloLens 2 udělat za vás?](hololens-commercial-features.md)
## zjistit edice HoloLens 2
### [porovnat možnosti HoloLens 2](hololens2-options.md)
### [Jenom zařízení – edice](hololens2-options-device-only.md)
### [Edice Remote Assist](hololens2-options-remote-assist.md)
### [Průmyslový edice](hololens2-options-industrial-edition.md)
#### [nejčastější dotazy k HoloLens 2 pro průmyslové edice](hololens2-industrial-edition-faq.md)
...
### [Edice Trimble XR10](hololens2-options-trimble-xr10-edition.md)
...
### [Aktualizovat HoloLens](hololens-update-hololens.md)
## Denní využití
### navigace Windows holografického rozhraní
#### [použití domovské stránky nabídka Start a smíšené reality](holographic-home.md)
#### [Využijte svůj hlas k provozu HoloLens](hololens-cortana.md)
#### [Hledání, otevírání a ukládání souborů na HoloLens](holographic-data.md)
#### [Vytvářejte fotky a videa ve smíšené realitě.](holographic-photos-and-videos.md)
#### [nová aplikace Nastavení](hololens-new-settings.md)
#### [Nový Microsoft Edge](hololens-new-edge.md)
### Správa aplikací
#### [Hledání, instalace a odinstalace aplikací pro Store](holographic-store-apps.md)
#### [správa vlastních aplikací pro HoloLens 2](hololens2-holographic-custom-apps.md)
### Optický hologram a umístění v prostoru
#### [Vylepšení vizuální kvality a pohodlí](hololens-calibration.md)
#### [Namapujte fyzické mezery pomocí HoloLens](hololens-spaces.md)
#### [předpoklady pro HoloLens prostředí](hololens-environment-considerations.md)
#### [Přesun platforem](hololens2-moving-platform.md)
### Připojení HoloLens 2
#### [Připojení HoloLens k síti](hololens-network.md)
#### [Připojení Bluetooth a zařízení USB-C](hololens-connect-devices.md)
#### [Připojení mobilní a 5G](hololens-cellular.md)
### [HoloLens 2 baterie a zpoplatnění](hololens2-charging.md)
### [HoloLens 2 – nejčastější dotazy k přizpůsobení a pohodlí](hololens2-fit-comfort-faq.md)
### [HoloLens 2 – časté otázky týkající se čištění](hololens2-maintenance.md)

# nasazení HoloLens 2
## [Obvyklé scénáře nasazení](hololens-requirements.md)
## [plánování nasazení HoloLens 2](hololens-core-components.md)
## Průvodce nasazením
### Průvodce nasazením propojeného prostředí v cloudu
...
## Identita
### [Správa identity a přihlášení uživatelů pro HoloLens](hololens-identity.md)
...
### [Správce – less – operační systém ](security-adminless-os.md)
### [Omezení použití hesla](security-limiting-password-use.md)
### [Ověření zabezpečení a ověřování modulem runtime na základě hardwaru](security-hardware-backed-integrity.md)
...
### [Zaregistrujte se Wi-Fi prostředí s omezeným přístupem s adresou MAC](mac-address-options.md)
## Nasazení aplikací
...
### [Instalační program aplikace](app-deploy-app-installer.md)
## Zásady (CSP)
### [Konfigurace CSP a Přehled správy zařízení](hololens-csp-policy-overview.md)
### [správa zařízení HoloLens pomocí MDM](hololens-mdm-configure.md)
### [konfigurace HoloLens pomocí zřizovacích balíčků](hololens-provisioning.md)
...
### [HoloLens Informace o beznabídkovém odkazu](hololens-kiosk-reference.md)
### [Windows Defender Řízení aplikací – WDAC](windows-defender-application-control-wdac.md)
### [Page Nastavení CSP a identifikátory uri pro HoloLens](settings-uri-list.md)
## Připojení k síti &
### [Konfigurace sítě pro HoloLens](hololens-commercial-infrastructure.md)
### [příprava certifikátů a profilů sítě pro HoloLens 2](hololens-certificates-network.md)
...
## [Restart, resetování nebo obnovení HoloLens 2](hololens-recovery.md)
...
#### [restartování, resetování nebo obnovení HoloLens (1. generace)](hololens1-recovery.md)
