...
description: Jak použít Advanced Recovery Companion k zobrazení flash HoloLens 2.
...
Pokud se zařízení nemůže spustit do spouštěcí nabídky, všimněte si vzhledu indikátoru LED a výčtu zařízení na hostitelském počítači. Pak postupujte podle průvodce [odstraňováním potíží.](hololens-troubleshooting.md) Pokud stav zařízení neodpovídá žádnému stavu uvedenému v průvodci odstraňováním potíží, proveďte postup pevného [resetování](hololens-recovery.md#hard-reset-procedure) se zařízením připojeným k napájecímu zdroji, ne s hostitelským počítačem. Počkejte alespoň jednu hodinu, než se zařízení bude účtovat.
...
5. Otevřete Správce zařízení (Windows 10 stiskněte klávesu **Windows** a potom klávesu **X** a pak vyberte **Správce zařízení**). Ujistěte se, že se zařízení správně *Microsoft HoloLens,* jak je znázorněno na následujícím obrázku:
   ...
   ![HoloLens 2: Maanger zařízení MicrosoftHoloLensRecovery 2](images/MicrosoftHoloLens_DeviceManager.png)

## <a name="clean-reflash-the-device"></a>Vyčištění zařízení před reflash

V mimořádných situacích možná budete muset "vyčistit blesk" HoloLens 2. Upozorňujeme, že neočekává se, že čisté zpětné lomítko ovlivní následující problémy:
...
Existují dva způsoby, jak zařízení namítt. V obou případech musíte nejdřív z úložiště úložiště Windows [Advanced Recovery Companion.](https://www.microsoft.com/store/productId/9P74Z35SFRS8)
...
Před zahájením postupu zpětného lomítka se ujistěte, že je aplikace nainstalovaná a spuštěná na počítači Windows 10 počítači a připravená k rozpoznání zařízení. Také se ujistěte, HoloLens vaše zařízení naúčtované minimálně na 40 %.

![HoloLens 2 snímek obrazovky s čistým zpětným lomítkem](images/ARC1.png)

### <a name="normal-procedure"></a>Normální postup

1. Když je HoloLens spuštěné, připojte ho k počítači Windows 10, na kterém jste předtím otevřeli doprovodnou aplikaci pro pokročilé obnovení.
...
Pokud se HoloLens 2 nespustí správně nebo pokud Advanced Recovery Companion nedokáže zařízení rozpoznat, možná budete muset zařízení přetát do režimu obnovení:
...
4. Připojení zařízení k hostitelskému počítači a otevřete Správce zařízení. (Windows 10 stiskněte klávesu **Windows,** pak **klávesu X** a pak vyberte **Správce zařízení**.) Ujistěte se, že se zařízení správně Microsoft HoloLens, jak je znázorněno na následujícím obrázku:
   ...
   ![HoloLens 2 čistého zpětného lomítka](images/ARC2.png)
