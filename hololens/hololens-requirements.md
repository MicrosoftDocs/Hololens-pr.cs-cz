...
Můžete být pracovníkem s rozhodovací pravomocí v oblasti obchodu, IT profesionálem nebo týmem pro inovace, který se HoloLens ve vaší organizaci. Naši průvodci nasazením při sestavování od důkazu konceptu až po škálované nasazení HoloLens v rámci vaší IT infrastruktury – bez ohledu na to, jak velká nebo malá. Nejběžnější jsou následující scénáře nasazení:
...
> [Průvodce nasazením připojeného ke cloudu](hololens2-cloud-connected-overview.md)

Pomocí příručky Externí klienti můžete nasadit zařízení do vzdálené lokality pro krátkodobé nebo dlouhodobé externí použití.
