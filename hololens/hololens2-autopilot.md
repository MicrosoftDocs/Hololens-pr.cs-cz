...
- Windows Holographic verze 2004 podporuje pouze připojení Autopilot přes ethernet. Před zapnutím HoloLens zkontrolujte, že je zařízení připojené k síti ethernet pomocí adaptéru USB-C na **Ethernet.** Při spuštění zařízení není nutná žádná interakce uživatele. Pokud plánujete nasavit Autopilot do mnoha HoloLens zařízení, doporučujeme naplánovat infrastrukturu adaptéru. Rozbočovače USB nedoporučujeme, protože často vyžadují instalaci dalších ovladačů třetích stran, které nejsou podporované v HoloLens.
...
1. Ověřte, že HoloLens zařízení uvedená a že jejich stav profilu je **Přiřazeno.**  
...
1. Prostředí Autopilotu vyžaduje přístup k internetu. Pokud chcete zajistit přístup k internetu, použijte jednu z následujících možností:
    ...
    - Připojení zařízení adaptéry USB-C na Wi-Fi pro bezdrátové připojení k internetu a nechat HoloLens 2 dokončit prostředí Autopilotu automaticky.
        ...
        > [!IMPORTANT]  
       > Zařízení, která se pokoušejí Wi-Fi sítích v OOBE pro Autopilot, musí být na [Windows Holographic verze 20H2.](hololens-release-notes.md#windows-holographic-version-20h2)
       >
...
Po nastavení uzlu RequireNetworkInOOBE tenantaLockdown CSP na virtuálním počítači HoloLens 2 jsou v OOBE zakázané následující operace:
