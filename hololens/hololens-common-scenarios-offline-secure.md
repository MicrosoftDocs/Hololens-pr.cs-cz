...
---
# <a name="common-scenarios--offline-secure-hololens-2"></a>Běžné scénáře – HoloLens 2 v režimu offline

## <a name="overview"></a>Přehled

Tato příručka obsahuje pokyny pro použití ukázkového zřizovacího balíčku, který uzamkne HoloLens 2 pro použití v zabezpečených prostředích s následujícími omezeními:
...
Windows 10 počítače
1. [Stáhněte si nejnovější soubor operačního systému HoloLens 2](https://aka.ms/hololens2download) přímo do počítače. 
...
1. Stáhněte si nebo nainstalujte [nejnovější nástroj Windows Configuration Designer (WCD)](https://www.microsoft.com/p/windows-configuration-designer/9nblggh4tx22?activetab=pivot:overviewtab) z Microsoft Store do počítače.
...
1. Připravte offline [obchodní aplikaci na nasazení PPKG.](app-deploy-provisioning-package.md) 
...
1. Projekt by se měl otevřít a teď byste měli mít seznam dostupných přizpůsobení:
   ...
   |     První prostředí / HoloLens / WiFi                  |     Ano                          |     Přeskočí Wi-Fi konfigurace během počátečního nastavení zařízení.                                                                                 |
   |     Zásady/Připojení/AllowBluetooth                |     No                            |     Zakáže Bluetooth.                                                                                                             |
   |     Zásady/Prostředí/AllowCortana                    |     No                            |     Zakáže Cortanu (aby se eliminly potenciální problémy, protože mikrofony jsou zakázané)                                          |
...
1. Připojte HL2 k počítači Windows 10 pomocí kabelu USB.
...
1. Počkejte, až nástroj ARC dokončí instalaci operačního systému HoloLens 2.
...
1. Na holoLens 2 stiskněte následující kombinaci tlačítek, aby se spouštěl zřizovací balíček: **Klepněte** současně na Snížení objemu a tlačítko napájení. 
