...
Připojení připojte napájecí zdroj k portu pro účtování pomocí kabelu USB-C (který je součástí balení). Zapojte napájecí zdroj do napájecího zdroje. Nejlepší způsob, jak zařízení naúčtovat, je napájecí zdroj a kabel USB-C-HoloLens-C. 18 W energie (9V při 2A) dosáhnou 18 W energie. Pokud je zařízení v pohotovostním režimu, HoloLens 2 zařízení naplno naplno za méně než 65 minut.
...
Umístěte HoloLens 2 na hlavičku. Pokud máte brýle, nechejte je na sobě.  Na čedici by se měl nachytá čediče a zadní pásmo by mělo být uprostřed zad vaší hlavičky.
...
Pokud chcete odpojit přední část režijní podvěsky, uvolněte podsunout a protáhněte ho zatáhnoucí smyčkou na podložce. Pokud ho chcete znovu připojovat, vytáhněte smyčku a protáhněte ji zpět.
...
![připojte nebo odeberte HoloLens 2 hlavní smyka.](images/hololens2-headstrap.png)
...
> [!NOTE]
> Pokud chcete HoloLens 2 poprvé, po rozbalení stiskněte a podržte tlačítko napájení alespoň 4 sekundy, aby se zapne. Při příštím zapnutí HoloLens 2 se spustí po krátkém stisknutí tlačítka napájení.
...
Nejste si jistí, co znamenají indikátory na HoloLens indikátoru? Chcete vědět, jak se HoloLens při účtování chovat?  Tady je nějaká pomoc!

### <a name="charging-behavior"></a>Chování při účtování

| Stav zařízení | Akce | HoloLens 2 to bude |
| - | - | - |
| OFF | Zásuvný kabel USB | Zařízení se převádí do polohy ON (On) a indikátory zobrazující stav baterie a zařízení začne se nabít.
...
| Jedno světlo odchýlá a odchýlá | 20 až 5 % nebo nižší (kritická baterie) |
...
| - | - | - |
| Stisknete tlačítko napájení. | Jedno světlo se potěší pětkrát a pak se vypne. | HoloLens baterie je kriticky nízká. Účtovat HoloLens. |
| Stisknete tlačítko napájení. | Všechna pět světel za špičku a potom vypnout. |  HoloLens nelze správně spustit a je v chybovém stavu. [Přeinstalujte operační systém](hololens-recovery.md) a obnovte své zařízení. |
| Stisknete tlačítko napájení. | Indikátory 1., 3 a 5 se pohromadě blikají. |  HoloLens může dojít k selhání hardwaru. Obraťte se na [podporu](https://support.microsoft.com/en-us/supportforbusiness/productselection?sapid=3ec35c62-022f-466b-3a1e-dbbb7b9a55fb). |
...
využijte svůj HoloLens v bezpečném prostoru, bez překážek a netrip nebezpečí. Nepoužívejte ji, pokud potřebujete jasné pole zobrazení nebo nemůžete potvrdit plnou pozornost, například když pracujete na vozidle nebo máte jiné potenciálně nebezpečné aktivity.
